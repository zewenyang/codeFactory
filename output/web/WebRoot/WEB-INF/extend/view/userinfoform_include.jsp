...
<%@ include file="/commons/taglibs.jsp" %>
	...
	<tr>
		...
		<td>
		<input value="${UserInfoForm.birthDateString}" onclick="WdatePicker({dateFmt:'<%=UserInfo.FORMAT_BIRTH_DATE%>'})"  id="birthDateString" name="birthDateString"  maxlength="0" class="" />
		</td>
	</tr>
